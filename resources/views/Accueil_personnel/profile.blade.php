                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">{{ Session::get('Nomper') }}</h3>
                                                <h3 class="user-name m-t-0 mb-0">{{ Session::get('prenomper') }}</h3>
                                                <h6 class="text-muted">{{ Session::get('date_naissance') }}</h6>
                                                <small class="text-muted">{{ Session::get('grade') }}</small>
                                                <div class="staff-id">User ID : {{ Session::get('CIN') }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
