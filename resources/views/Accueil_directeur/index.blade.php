                ...
                <div class="col-md-10 mx-auto">
                    <div class="card my-3">
                        <div class="card-header">
                            ...
                            <a href="{{route('personnels.create')}}" class="btn add-btn" style="background-color: rgb(130, 219, 130);border:none"><i class="fa fa-plus"></i> Ajouter Personnel</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($personnels as $key => $personnel)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                ...
                                                </a><a href="" class="btn btn-sm btn-success mx-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
